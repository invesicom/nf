...
class AnalyzeRescrapingNeeds extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($allProducts as $product) {
            ...
            // Build distribution
            if ($uniqueCount <= 5) $distribution['1-5']++;
            elseif ($uniqueCount <= 10) $distribution['6-10']++;
            elseif ($uniqueCount <= 15) $distribution['11-15']++;
            elseif ($uniqueCount <= 20) $distribution['16-20']++;
            elseif ($uniqueCount <= 30) $distribution['21-30']++;
            elseif ($uniqueCount <= 50) $distribution['31-50']++;
